...
namespace Csd.Comisiones.Persistence.Migrations
{
    ...
    [Migration("20260421164316_UsuariosAuditoria_Migration")]
    partial class UsuariosAuditoria_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Csd.Comisiones.Domain.Entities.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Csd.Comisiones.Domain.Entities.UsuarioRol", b =>
                {
                    b.Property<int>("UsuarioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Csd.Comisiones.Domain.Entities.UsuarioRol", b =>
                {
                    b.HasOne("Csd.Comisiones.Domain.Entities.Rol", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Csd.Comisiones.Domain.Entities.Usuario", "Usuario")
                        .WithMany("Roles")
